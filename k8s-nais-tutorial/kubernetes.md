author: Team Aura
id: k8s-tutorial
summary: This tutorial walks you through Kubernetes basics
status: draft
feedback link:
...
This tutorial walks you through Kubernetes basics.
...
Go to https://YOUR_APP.127.0.0.1.xip.io/ and refresh a couple of times, notice how the hostname changes? This is due to the fact that
...
Check out the Kubernetes documentation over at [https://kubernetes.io/docs/](https://kubernetes.io/docs/). We can also recommend [the illustrated childrens guide to Kubernetes](https://www.youtube.com/watch?v=4ht22ReBjno).

If you want to learn about NAIS, you should take the [NAIS tutorial](https://navikt.github.io/codelabs/nais-tutorial/).
